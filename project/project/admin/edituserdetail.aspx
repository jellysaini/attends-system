<%@ Page Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="edituserdetail.aspx.cs" Inherits="project.admin.WebForm9" Title="Untitled Page" %>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                            <tr>
                                                <td style="width:50%" align="right">
                                                    <asp:Button ID="btn_save" runat="server" Text="Update" CssClass="btn" onclick="btn_save_Click" 
                                                        /></td>
                                                <td style="width:2%">&nbsp;</td>
                                                <td style="width:8%">
